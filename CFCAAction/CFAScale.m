...
static NSString *const CFCAScaleKeypath = @"scale";
static NSString *const CFCAScaleXKeypath = @"transform.scale.x";
static NSString *const CFCAScaleYKeypath = @"transform.scale.y";
...
- (void)executeWithTarget:(CALayer *)target forTime:(NSTimeInterval)time {
	...
	[target addAnimation:scaleX forKey:CFCAScaleKeypath];
	[target addAnimation:scaleY forKey:CFCAScaleKeypath];
}
