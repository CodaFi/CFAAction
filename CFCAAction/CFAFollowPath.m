...
static NSString *const CFCAFollowPathKeypath = @"position";
...
- (void)executeWithTarget:(CALayer *)target forTime:(NSTimeInterval)time {
	CAKeyframeAnimation * pathAnimation = [CAKeyframeAnimation animationWithKeyPath:CFCAFollowPathKeypath];
	...
	[target addAnimation:pathAnimation forKey:CFCAFollowPathKeypath];
}
